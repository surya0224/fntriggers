...
fare_record = db_fzDB.JUP_DB_ATPCO_Fares_change_1
fare_record_main = db_fzDB.JUP_DB_ATPCO_Fares_Rules

system_date = datetime(2017,8,18)
...
file_dates = ["20170820","20170821","20170822","20170823","20170824","20170825","20170826","20170827","20170828",
              ...
              "20170907","20170908","20170909","20170910","20170911","20170912","20170913"]
st = time.time()
count = 1

cur = fare_record.find({"file_date": {"$nin":["20170914","20170915"]},
                        "carrier": {"$nin":["FZ","EK","EY","ET","KU","GF","G9","QR"]}}, timeout = False).sort({"$natural":1}).skip(10098693)
...
# cur = record_2_cat_3_fn.find({"LAST_UPDATED_DATE": query_date})
# print "start", cur.count()
# count = 1
# for i in cur:
#     if i["ACTION"] == "2":
...
#     count += 1
#
# cur = record_2_cat_11_fn.find({"LAST_UPDATED_DATE": query_date})
# print "start", cur.count()
# count = 1
# for i in cur:
#     if i["ACTION"] == "2":
...
#     count += 1
#
# cur = record_2_cat_14_fn.find({"LAST_UPDATED_DATE": query_date})
# print "start", cur.count()
# count = 1
# for i in cur:
#     if i["ACTION"] == "2":
...
#     count += 1
#
# cur = record_2_cat_15_fn.find({"LAST_UPDATED_DATE": query_date})
# print "start", cur.count()
# count = 1
# for i in cur:
#     if i["ACTION"] == "2":
...
#     count += 1
#
# cur = record_2_cat_23_fn.find({"LAST_UPDATED_DATE": query_date})
# print "start", cur.count()
# count = 1
# for i in cur:
#     if i["ACTION"] == "2":
...
# cur = record_1.find({"LAST_UPDATED_DATE": query_date})
# print "start", cur.count()
# count = 1
# for i in cur:
#     if i["ACTION"] == "2":
