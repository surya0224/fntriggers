...
File Name: fare_rules_top_comp_2.py
...
carrier_list = ['FZ', 'EK']
st_1 = time.time()
cur_fare_record = fare_record.find({"carrier": {'$nin': carrier_list}, 'used': None}, no_cursor_timeout = True)
...
bulk = []
t = 0
temp_cur = fare_record.find({"carrier":{"$nin":carrier_list},"used":0}, no_cursor_timeout = True)
count = 1
print "stage 2 start"
for i in temp_cur:
    st = time.time()
