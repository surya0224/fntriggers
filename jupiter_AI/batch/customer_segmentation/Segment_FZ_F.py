...
#     cursor = row
#     try:
#         if cursor['origin'] == 'DXB' and cursor['destination'] == 'JED' and (
#                             '2017-08-30' <= cursor['dep_date'] <= '2017-09-04' or '2016-09-10' <= cursor[
#                     'dep_date'] <= '2016-09-15'
#             or '2018-08-19' <= cursor['dep_date'] <= '2018-08-24' or '2019-08-09' <= cursor[
#             'dep_date'] <= '2019-08-14'):
#             return "Haj"
...
#             , 'PAJ', 'PSI', 'PEW', 'UET', 'RYK', 'RAZ', 'SKT', 'RZS', 'SDT', 'SYW', 'SBQ', 'MPD', 'KDU', 'SUL',
#                                                                                     'SKZ', 'TLB', 'TUK', 'PZH'] and \
#                         cursor['destination'] in ['JED', 'MED'] and (
#                             '2016-01-01' <= cursor['dep_date'] <= '2016-06-30' or '2017-01-01' <= cursor[
#                     'dep_date'] <= '2017-06-30'
#             or '2018-01-01' <= cursor['dep_date'] <= '2018-06-30' or '2019-01-01' <= cursor['dep_date'] <= '2019-06-30'
#                             ) and cursor['fare_basis'][1:2] == 'R':
#             return "Umrah"
#     except:
#         pass
#
...
# limits = 1000000
#
# loop_coun = db.JUP_DB_Sales_Flown.find({'origin':{'$in':['DXB','KTM','BHV', 'CJL', 'CHB', 'DBA', 'DEA', 'DSK', 'LYP', 'GIL', 'GJT', 'GWD', 'HDD', 'ISB'
#                 , 'JAG', 'JIW', 'KCF', 'KHI', 'KDD', 'LHE', 'XJM', 'MJD', 'MUX', 'MFG', 'WNS', 'ORW', 'PJG'
#                 , 'PAJ', 'PSI', 'PEW', 'UET', 'RYK', 'RAZ', 'SKT', 'RZS', 'SDT', 'SYW', 'SBQ', 'MPD', 'KDU', 'SUL',
#                                       'SKZ', 'TLB', 'TUK', 'PZH']},'pos':{'$in':['KTM','UAE','BHV', 'CJL', 'CHB', 'DBA', 'DEA', 'DSK', 'LYP', 'GIL', 'GJT', 'GWD', 'HDD', 'ISB'
#                 , 'JAG', 'JIW', 'KCF', 'KHI', 'KDD', 'LHE', 'XJM', 'MJD', 'MUX', 'MFG', 'WNS', 'ORW', 'PJG'
#                 , 'PAJ', 'PSI', 'PEW', 'UET', 'RYK', 'RAZ', 'SKT', 'RZS', 'SDT', 'SYW', 'SBQ', 'MPD', 'KDU', 'SUL',
#                                       'SKZ', 'TLB', 'TUK', 'PZH']},'destination':{'$in':['JED','MED']}}).count()
...
#     cursor = pd.DataFrame(list(db.JUP_DB_Sales_Flown.find({'origin':{'$in':['DXB','KTM','BHV', 'CJL', 'CHB', 'DBA', 'DEA', 'DSK', 'LYP', 'GIL', 'GJT', 'GWD', 'HDD', 'ISB'
#                 , 'JAG', 'JIW', 'KCF', 'KHI', 'KDD', 'LHE', 'XJM', 'MJD', 'MUX', 'MFG', 'WNS', 'ORW', 'PJG'
#                 , 'PAJ', 'PSI', 'PEW', 'UET', 'RYK', 'RAZ', 'SKT', 'RZS', 'SDT', 'SYW', 'SBQ', 'MPD', 'KDU', 'SUL',
#                                       'SKZ', 'TLB', 'TUK', 'PZH']},'pos':{'$in':['KTM','UAE','BHV', 'CJL', 'CHB', 'DBA', 'DEA', 'DSK', 'LYP', 'GIL', 'GJT', 'GWD', 'HDD', 'ISB'
#                 , 'JAG', 'JIW', 'KCF', 'KHI', 'KDD', 'LHE', 'XJM', 'MJD', 'MUX', 'MFG', 'WNS', 'ORW', 'PJG'
#                 , 'PAJ', 'PSI', 'PEW', 'UET', 'RYK', 'RAZ', 'SKT', 'RZS', 'SDT', 'SYW', 'SBQ', 'MPD', 'KDU', 'SUL',
#                                       'SKZ', 'TLB', 'TUK', 'PZH']},'destination':{'$in':['JED','MED']}}, {'dep_date': 1,
