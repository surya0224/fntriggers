...
def quarter_logic(start_date,end_date):
    ...
    if len(months_to_remove[2]) != 0:
        ...
        try:
            end_date_55 = datetime.date(start_date_55.year, months_to_remove[0][0] - 1, 31)
        except:
            end_date_55 = datetime.date(start_date_55.year, months_to_remove[0][0] - 1, 30)
        start_date_66 = datetime.date(start_date_55.year, months_to_remove[0][-1] + 1, 1)
    ...
    if len(months_to_remove[3]) != 0:
        ...
        try:
            end_date_77 = datetime.date(start_date_77.year, months_to_remove[0][0] - 1, 31)
        except:
            end_date_77 = datetime.date(start_date_77.year, months_to_remove[0][0] - 1, 30)
        start_date_88 = datetime.date(start_date_77.year, months_to_remove[0][-1] + 1, 1)
    ...
    if len(months_to_remove[4]) != 0:
        ...
        try:
            end_date_99 = datetime.date(start_date_99.year, months_to_remove[0][0] - 1, 31)
        except:
            end_date_99 = datetime.date(start_date_99.year, months_to_remove[0][0] - 1, 30)
        start_date_10 = datetime.date(start_date_99.year, months_to_remove[0][-1] + 1, 1)
    ...
    if len(months_to_remove[5]) != 0:
        ...
        try:
            end_date_111 = datetime.date(start_date_111.year, months_to_remove[0][0] - 1, 31)
        except:
            end_date_111 = datetime.date(start_date_11.year, months_to_remove[0][0] - 1, 30)
        start_date_12 = datetime.date(start_date_111.year, months_to_remove[0][-1] + 1, 1)
    ...
    try:
        if start_date_11 != 0:
            if end_date_11 - start_date_11 > datetime.timedelta(7):
    ...
    try:
        if start_date_22 != 0:
            if end_date_22 - start_date_22 > datetime.timedelta(7):
    ...
    try:
        if start_date_33 != 0:
            if end_date_33 - start_date_33 > datetime.timedelta(7):
    ...
    try:
        if start_date_44 != 0:
            if end_date_44 - start_date_44 > datetime.timedelta(7):
    ...
    try:
        if start_date_55 != 0:
            if end_date_55 - start_date_55 > datetime.timedelta(7):
    ...
    try:
        if start_date_66 != 0:
            print "--"
            if end_date_66 - start_date_66 > datetime.timedelta(7):
    ...
    try:
        if start_date_77 != 0:
            if end_date_77 - start_date_77 > datetime.timedelta(7):
    ...
    try:
        if start_date_88 != 0:
            print "--"
            if end_date_88 - start_date_88 > datetime.timedelta(7):
    ...
    try:
        if start_date_99 != 0:
            if end_date_99 - start_date_99 > datetime.timedelta(7):
    ...
    try:
        if start_date_10 != 0:
            print "--"
            if end_date_10 - start_date_10 > datetime.timedelta(7):
    ...
    try:
        if start_date_111 != 0:
            if end_date_111 - start_date_111 > datetime.timedelta(7):
    ...
    try:
        if start_date_12 != 0:
            print "--"
            if end_date_12 - start_date_12 > datetime.timedelta(7):
    ...
    print results
        # start_date = datetime.date(2018, 3, 1)
    # end_date = datetime.date(2018, 12, 25)
quarter_logic(datetime.date(2018, 4, 1),datetime.date(2018,9, 26))
