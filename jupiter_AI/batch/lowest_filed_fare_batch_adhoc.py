...
def get_fares_df(pos, origin, destination, compartment, extreme_start_date, extreme_end_date, db, comp=[Host_Airline_Code]):
    ...
    if len(tax_crsr) != 0:
        ...
        tax_df = pd.DataFrame(columns=['Fixed_tax',
                                       'Percent_tax',
                                       'Origin',
                                       'Destination',
                                       'Currency',
    ...
    tax_df = tax_df.rename(
        columns={
            ...
            'Fixed_tax': 'tax_value_from_master'})
    ...
    if len(fares_data) > 0:
        ...
        dF[['tax_currency',
            'tax_value_from_master', "percent_tax"]] = dF[['tax_currency',
                                            'tax_value_from_master', "percent_tax"]].fillna(-999)
        ...
        dF['taxes'] = dF['taxes'] + (dF['percent_tax']/100)*dF['fare']
...
if __name__ == '__main__':
    ...
    for i in markets:
        ...
        #update_market_adhoc(i[0:3], i[3:6], i[6:9], i[9:10], db_b)
    group2 = group(lff)
    res2 = group2()
    res2.get()
