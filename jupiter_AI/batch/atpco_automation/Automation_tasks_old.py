...
from jupiter_AI.batch.atpco_automation.fr import run_stage_2
...
##@measure(JUPITER_LOGGER)
def run_record_4_5(system_date):
    try:
        client = mongo_client()
        st = time.time()
        ...
        logger_start = start_delimiter + \
                       ...
                       datetime.datetime.now().strftime("%Y-%m-%d %H:%M:%S")
        logger.info(logger_start)
        record_4_5(system_date=system_date, client=client)
        time_taken = time.time() - st
        logger_info = end_delimiter + \
...
##@measure(JUPITER_LOGGER)
def run_record_0_change(system_date):
    try:
        client = mongo_client()
        st = time.time()
        ...
        logger_start = start_delimiter + \
                       ...
                       datetime.datetime.now().strftime("%Y-%m-%d %H:%M:%S")
        logger.info(logger_start)
        record_0_change(system_date=system_date, client=client)
        time_taken = time.time() - st
        logger_info = end_delimiter + \
...
##@measure(JUPITER_LOGGER)
def run_record_1_change(system_date):
    try:
        client = mongo_client()
        st = time.time()
        ...
        logger_start = start_delimiter + \
                       ...
                       datetime.datetime.now().strftime("%Y-%m-%d %H:%M:%S")
        logger.info(logger_start)
        record_1_change(system_date=system_date, client=client)
        time_taken = time.time() - st
        logger_info = end_delimiter + \
...
##@measure(JUPITER_LOGGER)
def run_record_8_change(system_date):
    try:
        client = mongo_client()
        st = time.time()
        ...
        logger_start = start_delimiter + \
                       ...
                       datetime.datetime.now().strftime("%Y-%m-%d %H:%M:%S")
        logger.info(logger_start)
        record_8_change(system_date=system_date, client=client)
        time_taken = time.time() - st
        logger_info = end_delimiter + \
...
##@measure(JUPITER_LOGGER)
def run_record_2_cat_all_change(system_date):
    try:
        client = mongo_client()
        st = time.time()
        ...
        logger_start = start_delimiter + \
                       ...
                       datetime.datetime.now().strftime("%Y-%m-%d %H:%M:%S")
        logger.info(logger_start)
        record_2_cat_all_change(system_date=system_date, client=client)
        time_taken = time.time() - st
        logger_info = end_delimiter + \
...
##@measure(JUPITER_LOGGER)
def run_record_2_cat_10_change(system_date):
    try:
        client = mongo_client()
        st = time.time()
        ...
        logger_start = start_delimiter + \
                       ...
                       datetime.datetime.now().strftime("%Y-%m-%d %H:%M:%S")
        logger.info(logger_start)
        record_2_cat_10_change(system_date=system_date, client=client)
        time_taken = time.time() - st
        logger_info = end_delimiter + \
...
##@measure(JUPITER_LOGGER)
def run_record_2_cat_25_change(system_date):
    try:
        client = mongo_client()
        st = time.time()
        ...
        logger_start = start_delimiter + \
                       ...
                       datetime.datetime.now().strftime("%Y-%m-%d %H:%M:%S")
        logger.info(logger_start)
        record_2_cat_25_change(system_date=system_date, client=client)
        time_taken = time.time() - st
        logger_info = end_delimiter + \
...
##@measure(JUPITER_LOGGER)
def run_record_2_cat_3_fn_change(system_date):
    try:
        client = mongo_client()
        st = time.time()
        ...
        logger_start = start_delimiter + \
                       ...
                       datetime.datetime.now().strftime("%Y-%m-%d %H:%M:%S")
        logger.info(logger_start)
        record_2_cat_3_fn_change(system_date=system_date, client=client)
        time_taken = time.time() - st
        logger_info = end_delimiter + \
...
##@measure(JUPITER_LOGGER)
def run_record_2_cat_11_fn_change(system_date):
    try:
        client = mongo_client()
        st = time.time()
        ...
        logger_start = start_delimiter + \
                       ...
                       datetime.datetime.now().strftime("%Y-%m-%d %H:%M:%S")
        logger.info(logger_start)
        record_2_cat_11_fn_change(system_date=system_date, client=client)
        time_taken = time.time() - st
        logger_info = end_delimiter + \
...
##@measure(JUPITER_LOGGER)
def run_record_2_cat_14_fn_change(system_date):
    try:
        client = mongo_client()
        st = time.time()
        ...
        logger_start = start_delimiter + \
                       ...
                       datetime.datetime.now().strftime("%Y-%m-%d %H:%M:%S")
        logger.info(logger_start)
        record_2_cat_14_fn_change(system_date=system_date, client=client)
        time_taken = time.time() - st
        logger_info = end_delimiter + \
...
##@measure(JUPITER_LOGGER)
def run_record_2_cat_15_fn_change(system_date):
    try:
        client = mongo_client()
        st = time.time()
        ...
        logger_start = start_delimiter + \
                       ...
                       datetime.datetime.now().strftime("%Y-%m-%d %H:%M:%S")
        logger.info(logger_start)
        record_2_cat_15_fn_change(system_date=system_date, client=client)
        time_taken = time.time() - st
        logger_info = end_delimiter + \
...
##@measure(JUPITER_LOGGER)
def run_record_2_cat_23_fn_change(system_date):
    try:
        client = mongo_client()
        st = time.time()
        ...
        logger_start = start_delimiter + \
                       ...
                       datetime.datetime.now().strftime("%Y-%m-%d %H:%M:%S")
        logger.info(logger_start)
        record_2_cat_23_fn_change(system_date=system_date, client=client)
        time_taken = time.time() - st
        logger_info = end_delimiter + \
...
def run_recseg2(system_date):
    try:
        ...
        logger_start = start_delimiter + \
                       ...
                       datetime.datetime.now().strftime("%Y-%m-%d %H:%M:%S")
        logger.info(logger_start)
        recseg2(system_date=system_date, client=client)
        time_taken = time.time() - st
        logger_info = end_delimiter + \
...
def run_recseg3(system_date):
    try:
        ...
        logger_start = start_delimiter + \
                       ...
                       datetime.datetime.now().strftime("%Y-%m-%d %H:%M:%S")
        logger.info(logger_start)
        recseg3(system_date=system_date, client=client)
        time_taken = time.time() - st
        logger_info = end_delimiter + \
...
##@measure(JUPITER_LOGGER)
def run_fares_and_stage_1(system_date, carrier_list, tariff_list):
    try:
        client = mongo_client()
        st = time.time()
        ...
        logger_start = start_delimiter + \
                       ...
                       datetime.datetime.now().strftime("%Y-%m-%d %H:%M:%S")
        logger.info(logger_start)
        returned_ids = fare_changes(system_date=system_date, carrier_list=carrier_list,
        ...
        for k in range(int(math.ceil(len(returned_ids) / 100.0))):
            ...
            stage_2.append(run_stage_2_rules.s(system_date=fr_date, id_list=temp))
...
##@measure(JUPITER_LOGGER)
def run_stage_2_rules(system_date, id_list):
    try:
        client = mongo_client()
        st = time.time()
        ...
        logger_start = start_delimiter + \
                       ...
                       datetime.datetime.now().strftime("%Y-%m-%d %H:%M:%S")
        logger.info(logger_start)
        run_stage_2(system_date=system_date, id_list=id_list, client=client)
        time_taken = time.time() - st
        logger_info = end_delimiter + \
...
def run_manual_trigger_summary_to_landing_page(user):
    try:
        ...
        _kwargs = run_manual_trigger_summary_to_landing_page.request.kwargs
...
##@measure(JUPITER_LOGGER)
def run_manual_trigger_summary_popular_fare():
    try:
        client = mongo_client()
        st = time.time()
        ...
        logger_start = start_delimiter + \
                       ...
                       datetime.datetime.now().strftime("%Y-%m-%d %H:%M:%S")
        logger.info(logger_start)
        manual_trigger_summary_popular_fare(client=client)
        time_taken = time.time() - st
        logger_info = end_delimiter + \
...
def run_yqyr(system_date, carrier, OD, hub, hub_area, hub_country, hub_zone, origin_area,
    ...
    try:
        ...
        logger_start = start_delimiter + \
                       ...
                       datetime.datetime.now().strftime("%Y-%m-%d %H:%M:%S")
        logger.info(logger_start)
        yqyr_main(system_date=system_date, carrier_list=carrier, OD_list=OD, hub=hub, hub_area=hub_area, hub_country=hub_country, hub_zone=hub_zone, origin_area=origin_area,
...
def run_yqyr_changetab():
    try:
        ...
        logger_start = start_delimiter + \
                       ...
                       datetime.datetime.now().strftime("%Y-%m-%d %H:%M:%S")
        logger.info(logger_start)
        yqyrchangetab_main(client=client)
        time_taken = time.time() - st
        logger_info = end_delimiter + \
...
def run_yqyr_tab178190():
    try:
        ...
        logger_start = start_delimiter + \
                       ...
                       datetime.datetime.now().strftime("%Y-%m-%d %H:%M:%S")
        logger.info(logger_start)
        yqyr_tab178190_main(client=client)
        time_taken = time.time() - st
        logger_info = end_delimiter + \
...
def run_yqyr_tab171198():
    try:
        ...
        logger_start = start_delimiter + \
                       ...
                       datetime.datetime.now().strftime("%Y-%m-%d %H:%M:%S")
        logger.info(logger_start)
        yqyr_tab171198_main(client=client)
        time_taken = time.time() - st
        logger_info = end_delimiter + \
...
def run_yqyr_s1change():
    try:
        ...
        logger_start = start_delimiter + \
                       ...
                       datetime.datetime.now().strftime("%Y-%m-%d %H:%M:%S")
        logger.info(logger_start)
        yqyr_s1change_main(client=client)
        time_taken = time.time() - st
        logger_info = end_delimiter + \
...
def run_yqyr_s1reverse(file_date):
    try:
        client=mongo_client()
        st = time.time()
        ...
        logger_start = start_delimiter + \
                       ...
                       datetime.datetime.now().strftime("%Y-%m-%d %H:%M:%S")
        logger.info(logger_start)
        yqyr_s1reverse_main(file_date,client=client)
        time_taken = time.time() - st
        logger_info = end_delimiter + \
...
def run_lff_adhoc(pos, origin, destination, compartment):
    ...
    logger_start = start_delimiter + \
                   ...
                   datetime.datetime.now().strftime("%Y-%m-%d %H:%M:%S")
    logger.info(logger_start)
    update_market_adhoc(pos=pos, origin=origin, destination=destination, compartment=compartment, client=client)
    time_taken = time.time() - st
    logger_info = end_delimiter + \
...
def run_temp_fares_collection():
    try:
        ...
        logger_start = start_delimiter + \
                       ...
                       datetime.datetime.now().strftime("%Y-%m-%d %H:%M:%S")
        logger.info(logger_start)
        create_temp_fares_collection(client=client)
        time_taken = time.time() - st
        logger_info = end_delimiter + \
