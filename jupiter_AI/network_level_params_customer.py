...
MONGO_CLIENT_URL = '104.211.201.88:27022'
ANALYTICS_MONGO_USERNAME = 'mgadmin'
ANALYTICS_MONGO_PASSWORD = 'mgadmin@2018'
MONGO_SOURCE_DB = 'admin'
JUPITER_DB = 'fzDB_stg'
ATPCO_DB = 'ATPCO_stg'
RABBITMQ_HOST = '104.211.201.88'
RABBITMQ_PORT = 5672
RABBITMQ_USERNAME = 'flynava'
RABBITMQ_PASSWORD = 'flynava@1234'
JAVA_URL = "http://104.211.201.88:8080/jupiter/getManualTriggers"
...
MAIL_RECEIVERS = ["data@flynava.com"]
PYTHON_PATH = '/var/www/html/jupiter/python/'
