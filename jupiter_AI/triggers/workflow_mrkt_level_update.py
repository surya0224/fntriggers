...
from jupiter_AI.triggers.recommendation_models.competitor_match import comp_match as get_fares_data
...
def main_func(
    ...
    # ////////////////////////////////////////////////////
        ...
        significant_crsr = list(db.JUP_DB_Target_OD.find(
            {"pos": pos, "origin": origin, "destination": destination,"compartment" : compartment, "month": int(SYSTEM_DATE[5:7]),
             "year": int(SYSTEM_DATE[0:4]), 'pax': {'$gte': 100}}, {"significant_target": 1}).sort([("snap_date", pymongo.DESCENDING)]).limit(1))
...
if __name__ == '__main__':
    ...
    main_func("AMM", "AMM", "DXB", "Y", "2019-07-01", "2019-07-31",
              dates_list=[{"start": "2017-07-01", "end": "2019-07-31"}],db=db, is_manual=1)
