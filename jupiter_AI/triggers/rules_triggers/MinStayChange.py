...
def main():
    client = mongo_client()
    new_df = get_new_rules_df(cat='006', record_3='JUP_DB_ATPCO_Record_3_Cat_06',
                              fields={'MINSTAY': 1, 'UNIT': 1}, client=client)
    if new_df is not None:
        old_df = get_old_rules_df(new_df=new_df, record_3='JUP_DB_ATPCO_Record_3_Cat_06',
                                  fields={'MINSTAY': 1, 'UNIT': 1}, client=client)
        ...
        df = get_host_rules(df=df, cat='cat_6', client=client)
