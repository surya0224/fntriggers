"""
File Name              :   Average_fare_price_BLL
...
import jupiter_AI.RnA.Average_fare_price_DAL as dal
...
def check_average_fare_price(dict_scr_filter):
    """
...
def rna_average_fare_price(dict_scr_filter):

    """
    the function rna_average_fare_price will be called to check the value of the average_fares.
    ...
    ******** please enter codes to do the above ***********
    ...
    rna_response = dict()
    average_fare_price_collection_name = dal.get_average_fare_price_rna_data(dict_scr_filter)
    ...
    if len(average_fare_price_collection_name) == 0:
        ...
        #As for now displaying text

        what = 'Average_fare - Price'
        why = 'Lower fares with respect to  past period'
        status_quo = 'Average fare will keep falling'
        action = 'Appropriate prices to be set and review the average  prices of competitors', 'Use Simulation to arrive at price'

    elif len(average_fare_price_collection_name) == 1:
...
if __name__ == '__main__':
    ...
    print rna_average_fare_price (a)