"""
File Name              :   MarketShare_Fares_TnC_BLL
...
import jupiter_AI.RnA.MarketShare_Fares_TnC_DAL as DAL
...
def rna_fares_TnC(dict_scr_filter):
    ...
    ******** please enter codes to do the above ***********
    ...
    if len(market_share_collection) == 0:
        ...
        what = 'Markets Share - Fares terms and conditions'
        why = 'Non competitive terms and conditions'
        status_quo = 'Further drop in market share'
        action = 'Do not react if current market share is above fair market share. Build long ' \
                 'term solutions.'
