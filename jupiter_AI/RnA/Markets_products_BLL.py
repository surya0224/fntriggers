...
"""
File Name              :   MarketShare_PRODUCTS_BLL
Author                 :   Pavanimha Reddy
...
import jupiter_AI.RnA.Markets_products_DAL as DAL
...
def rna_PRODUCTS(dict_scr_filter):
    ...
    ******** please enter codes to do the above ***********
    ...
    if len(market_share_collection) == 0:
        ...
        what = 'Markets Share - Products-Physical'
        why = 'Low competitor rating  on products'
