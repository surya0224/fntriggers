...
"""
File Name              :   MarketShare_ChanelsPromo_BLL
...
import jupiter_AI.RnA.MarketShare_ChanelsPromo_DAL as DAL
...
def rna_channels_promo(dict_scr_filter):
    ...
    ******** please enter codes to do the above ***********
    ...
    if len(market_share_collection) == 0:
        ...
        what = 'Markets Share - Channels Promo'
        why = 'There are special promotions on the web'
