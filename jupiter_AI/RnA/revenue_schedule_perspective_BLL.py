"""
File Name              :   revenue_schedule_perspective_BLL
Author                 :   Ashwin Kumar
Date Created           :   2016-12-16
Description            :   RnA analysis for increasing/decreasing revenue from a price perspective.
...
import jupiter_AI.RnA.revenue_schedule_perspective_DAL as dal
...
def rna_schedule_flights_per_time(dict_scr_filter):
    ...
    ******** please enter codes to do the above ***********
    ...
    if len(schedule_collection) == 0:
        ...
        what = 'Bookings'
        why = 'The number of flights per day or flights per week is lower when compared' \
              'to competitor'
        ...
        # values will be displayed
        what = 'Schedule'
        why = 'The number of flights per day or flights per week is lower when comparted' \
              'to competitor'
        status_quo = 'Further drop in Revenue'
        action = 'Adjust Price based on pricing model. Use simulation to arrive at a Price. Not an issue when ' \
                 '90 percent of capacity is booked'
