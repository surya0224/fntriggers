"""
File Name              :   Average_fare_odmix_BLL
...
import jupiter_AI.RnA.Average_fare_odmix_DAL as dal
...
def check_average_fare_odmix(dict_scr_filter):
    """
...
def rna_average_fare_odmix(dict_scr_filter):
    ...
    ******** please enter codes to do the above ***********
    ...
    rna_response = dict()
    average_fare_odmix_collection_name = dal.get_average_fare_odmix_rna_data(dict_scr_filter)
    ...
    if len(average_fare_odmix_collection_name) == 0:
        ...
        what = 'Average_fare - odmix'
        why = 'Inappropriate O&D mix'
        status_quo = 'Average fare will keep falling'
        action = 'Review odmix'

    elif len(average_fare_odmix_collection_name) == 1:
...
if __name__ == '__main__':
    ...
    print rna_average_fare_odmix(a)