"""
File Name              :   Average_fare_revenue_management_RNA_perspective_DAL
...
import jupiter_AI.RnA.Average_fare_revenue_management_DAL as dal
...
"""
Based on the filter on screen check the status of Average_fares (if it is low or high)
    Average_fares
        reveneue_management -
...
def check_average_fare_revenue_management(dict_scr_filter):
    """
...
def rna_average_fare_revenue_management(dict_scr_filter):

    """
    the function rna_average_fare_revenue_management will be called to check the value of the average_fares.
    ...
    ******** please enter codes to do the above ***********
    ...
    rna_response = dict()
    average_fare_revenue_management_collection_name = dal.get_average_fare_revenue_management_rna_data(dict_scr_filter)
    ...
    if len(average_fare_revenue_management_collection_name) == 0:
        ...
        what = 'Average_fare - revenue_management'
        why = 'Inappropriate flight control'
        status_quo = 'Average fare will keep falling'
        action = 'Appropriate prices to be set and review the average prices of competitors(review flight controls)', 'Use Simulation to arrive at price'


    elif len(average_fare_revenue_management_collection_name) == 1:
...
if __name__ == '__main__':
    ...
    print rna_average_fare_revenue_management(a)