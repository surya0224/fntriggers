"""
File Name              :   market_share_competition_capacity_perspective_BLL
Author                 :   Ashwin Kumar
...
import jupiter_AI.RnA.market_share_competiton_capacity_perspecitve_DAL as dal
...
def rna_market_share_capacity_competitors(dict_scr_filter):
    ...
    ******** please enter codes to do the above ***********
    ...
    rna_response = dict()
    capacity_collection = dal.get_host_competiton_capacity_related_data(dict_scr_filter)
    ...
    if len(capacity_collection) == 0:
        ...
        what = 'Competition_Capacity'
        why = 'Competition has  increased its capacity.' \
              'The host has decreased its capacity'
