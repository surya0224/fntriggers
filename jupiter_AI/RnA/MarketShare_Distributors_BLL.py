...
"""
File Name              :   MarketShare_Distributors_BLL
Author                 :   Shamail Mulla
Date Created           :   2016-12-19
Description            :   RnA analysis for increasing/decreasing market share from the perspective of distributors.
...
import jupiter_AI.RnA.MarketShare_Distributors_DAL as DAL
...
def rna_channels_promo(dict_scr_filter):
    ...
    ******** please enter codes to do the above ***********
    ...
    if len(market_share_collection) == 0:
        ...
        what = 'Markets Share - Distributors'
        why = 'There are special fares given to consolidators or GSAs that are not in the published world'
        status_quo = 'Further drop in market share'
        action = 'Do not react if current market share is above fair market share. If not, offer deals to' \
                 'a few of the distributors. Use ATPCO diffuser to distribute private fares'
